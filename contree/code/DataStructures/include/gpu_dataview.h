...
void split_gpu_dataview(const GPUDataview& parent, GPUDataview& left, GPUDataview& right, int split_feat_idx, int split_point, cudaStream_t stream = 0);

void split_gpu_dataview_preallocated(const GPUDataview& parent, GPUDataview& left, GPUDataview& right, int split_feat_idx, int split_point, int* d_row_map_buffer, cudaStream_t stream = 0);
